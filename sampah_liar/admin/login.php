...
<head>
    ...
    <style>
        ...
        .login-card { background: white; border-radius: 24px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); padding: 40px; width: 100%; max-width: 420px; }
    ...
    <div class="login-page">
        <div class="login-card animate-fade-in">
            <div class="login-logo">
                ...
                <h2>Admin SiPAL</h2>
                <p>Panel Administrator & Petugas</p>
            </div>
            ...
            <form method="POST" action="">
                <div class="form-floating mb-3">
                    ...
                    <label for="username"><i class="fas fa-user-shield me-2 text-gray"></i>Username Admin</label>
                </div>
